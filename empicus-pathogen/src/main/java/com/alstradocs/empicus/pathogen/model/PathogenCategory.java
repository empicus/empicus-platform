 ...
 */
@Entity
@Table(name="PATHOGEN_CATEGORY")
public class PathogenCategory extends BaseEntity {

	private static final long serialVersionUID = 1L;
    public static final String ARTIFACT_NAME = "PathogenCategory";
	private String description;

    public PathogenCategory() {
    }
