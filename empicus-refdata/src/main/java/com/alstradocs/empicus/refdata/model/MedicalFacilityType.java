 ...
 */
@Entity
@Table(name="MEDICAL_FACILITY_TYPE")
public class MedicalFacilityType extends BaseEntity {

	private static final long serialVersionUID = 1L;
    public static final String ARTIFACT_NAME = "MedicalFacilityType";
	private String description;

    public MedicalFacilityType() {
    }
