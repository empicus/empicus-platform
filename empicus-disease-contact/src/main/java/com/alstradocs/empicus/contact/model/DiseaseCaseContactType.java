 ...
 */
@Entity
@Table(name="DISEASE_CASE_CONTACT_TYPE")
public class DiseaseCaseContactType extends BaseEntity {

	private static final long serialVersionUID = 1L;
    public static final String ARTIFACT_NAME = "DiseaseCaseContactType";
	@NotNull(message="The description is required.")
	private String description;

    public DiseaseCaseContactType() {
    }
